                            ...
                            <TableCell>
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 duration-150"
                                    >
                                        Accept
                                    </button>
                                    <button
                                        onClick={() => handleReject(request.id)}
                                        className="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 duration-150"
                                    >
                                        Deny
                                    </button>
                                </div>
